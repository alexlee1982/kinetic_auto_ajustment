  ...
  var tpl ='\<div class="csdn-toolbar csdn-toolbar'+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="col-md-5 pull-left left-menu clearfix">\
            ...
            <li><a href="//blog.csdn.net/?ref=toolbar" class="toolbar_to_feed" title="博客" target="_blank">博客</a></li>\
            <li><a href="//edu.csdn.net?ref=toolbar" title="学院" target="_blank">学院</a></li>\
            <li><a href="//download.csdn.net?ref=toolbar" title="下载" target="_blank">下载</a></li>\
            <li><a href="//gitbook.cn/?ref=csdn" title="GitChat" target="_blank">GitChat</a></li>\
            <li class="show-more">\
            <a href="javascript:;"class="show-more-a">更多<i class="iconfont-toolbar toolbar-xiajiantou"></i></a>\
              <div class="more">\
                <div><a href="//bbs.csdn.net?ref=toolbar" target="_blank">论坛</a></div>\
                <div><a href="//ask.csdn.net?ref=toolbar" target="_blank">问答</a></div>\
                <div><a href="//huiyi.csdn.net/?ref=toolbar" target="_blank">活动</a></div>\
                <div><a href="https://gitee.com/?utm_source=csdn_toolbar" target="_blank">码云</a></div>\
                <div><a href="//mall.csdn.net?ref=toolbar" target="_blank">商城</a></div>\
                <div><a href="//www.iteye.com?ref=toolbar" target="_blank">ITeye</a></div>\
                <div><a href="//geek.csdn.net?ref=toolbar" target="_blank">极客头条</a></div>\
              </div>\
            </li>\
          </ul>\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              <li>\
                <div class="search_bar csdn-tracking-statistics tracking-click" data-mod="popu_366">\
                  ...
                  <a href="javascript:;" class="btn-nobg-noborder btn-search ico_search"><i class="iconfont-toolbar toolbar-sousuo"></i></a>\
                </div>\
              </li>\
              <li class="write-bolg-btn csdn-tracking-statistics tracking-click" data-mod="popu_370"><a class="" href="//write.blog.csdn.net/postedit?ref=toolbar" target="_blank"><i class="iconfont-toolbar toolbar-icon_boke"></i></a></li>\
              <li class="gitChat"><a class="" href="//gitbook.cn/new/gitchat/activity?utm_source=csdnblog1" target="_blank"><i class="iconfont-toolbar toolbar-icon_gitchatx"></i></a></li>\
              ...
              <li class="userLogin">\
                ...
                <div class="userControl">\
                  <div><a href="//blog.csdn.net/'+currUser.userName +'?ref=toolbar" target="_blank">我的博客</a></div>\
                  ...
                  <div><a href="//oldblog.csdn.net/home/help.html" target="_blank">帮助</a></div>\
