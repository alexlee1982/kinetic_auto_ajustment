...
/*! \todo FIXME - */// 2010.05.18 tapping:攻丝reversing:反转(减速停) retraction:退出final_reversal:最终反转(减速停) final_placement:最终定位
typedef enum {
...
//	int ioaddr;
	...
	char fileName[MAX_FILENAME_LENGTH];           // 文件号---11.07.25
